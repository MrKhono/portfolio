...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Armand Khono
            {/* <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
        ...
        <p className="home__description">Je suis Développeur Web & Mobile basé à Dakar, et je suis très passioné et dévoué à mon travail.</p>
